...
from PyQt5.QtWidgets import QApplication, QMainWindow, QStackedWidget, QAction, QWidgetAction, QComboBox, QSizePolicy, \
    QSpinBox, QHBoxLayout, QLabel, QWidget, QCheckBox, QLineEdit, QPushButton, QMessageBox, QMenu, QSystemTrayIcon, \
    QToolBar, QDialog
...
class MainWindow(QMainWindow):
    ...
    def __setActions(self):
        ...
        self.__stackBtn.setToolTip('Stack on Top')
        ...
        self.__langCmbBox.addItems(['it'])
        self.__langCmbBox.setCurrentText('it')
    ...
    def __lang_changed(self, lang):
        msg_box = QMessageBox()
        msg_box.setWindowTitle('Language Change')
        msg_box.setText('When changing the language, the program needs to be restarted. Would you like to restart it?')
